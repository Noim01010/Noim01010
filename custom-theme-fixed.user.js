// ==UserScript==
// @name         크랙 말풍선 커스텀 스킨 (PC + 모바일 대응)
// @description  말풍선 색상 커스터마이징 / 모바일 대응
// @version      1.4
...
(function () {
  ...
  const insertToggleButton = () => {
    ...
    const observer = new MutationObserver(() => {
      const container = document.querySelector('.css-j7qwjs') || document.querySelector('nav ul') || document.querySelector('main');
      if (container && !document.querySelector('#skinToggleBtn')) {
